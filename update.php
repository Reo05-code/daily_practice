...
<body>
   ...
   <form action="update.php?id=<?= $_GET['id'] ?>" method="post">
      <div>
         ...
         <input type="text" id="user_email" name="user_email" value="<?= $user['email'] ?>" maxlength="255" required>
         ...
         <input type="text" id="user_address" name="user_address" value="<?= $user['address'] ?>"maxlength="255" required>
         </div>
